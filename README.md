...
Click the red dots on the map to see the names of creators who have holdings at SCUA as well as the cities that they lived in. Note that some creators show up multiple times on the map, as they have lived in many locations.
